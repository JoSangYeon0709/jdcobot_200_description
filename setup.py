...
package_name = 'jdcobot_200_description'
...
setup(
    ...
    description='URDF Description package for jdcobot_200_description',
    license='Apache-2.0',

    entry_points={
        'console_scripts': [
            'js_5_pub_test = jdcobot_200_description.js_5_pub_test:main',
        ],
    },
)
